    ...
    if submissions:
        for sub in submissions:
            data.append({
                ...
                "device_timestamp": sub.device_timestamp.isoformat() if sub.device_timestamp else None,
                "server_timestamp": sub.server_timestamp.isoformat() if sub.server_timestamp else None,
                "status": sub.status,
