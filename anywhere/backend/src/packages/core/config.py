...
# Google OAuth
GOOGLE_CLIENT_ID = config.get("GOOGLE_CLIENT_ID", os.environ.get("GOOGLE_CLIENT_ID"))
GOOGLE_CLIENT_SECRET = config.get("GOOGLE_CLIENT_SECRET", os.environ.get("GOOGLE_CLIENT_SECRET"))
